...
function WordmarkAww() {
  return (
    <span className="wordmark2 inline-flex items-baseline gap-3">
      <span className="wm2-main font-extrabold tracking-tight leading-none">
        Peter&nbsp;Todd
      </span>
...
function KineticHero() {
  ...
  const haloRotate = useTransform(scrollYProgress, [0, 1], [0, 8]);
  const subOpacity = useTransform(scrollYProgress, [0, 0.5], [1, 0.4]);
  ...
  return (
    <section id="home" ref={ref} className="relative overflow-hidden scroll-mt-24">
      ...
      <motion.div
        ...
        className="hero-halo"
      />
      <div className="mx-auto max-w-7xl px-4 sm:px-6 pt-16 sm:pt-24 md:pt-28 pb-16 sm:pb-24 text-center relative z-10">
        ...
        <motion.h1
          ...
          className="kinetic-heading text-[11vw] sm:text-6xl md:text-7xl font-black tracking-tight leading-[1.05]"
        >
          The future of Bitcoin
          <span className="block heading-gradient">powered by Peter Todd</span>
        </motion.h1>

        <motion.p
          style={{ opacity: subOpacity }}
          className="mt-5 sm:mt-6 text-base sm:text-lg md:text-xl text-white/85 mx-auto max-w-2xl sm:max-w-3xl"
        >
          Investments and strategic support: Peter Todd Bitcoin is launching a
          next-generation blockchain, offering a limited circle of investors a
          unique opportunity to become co-owners of the project. Every
          contribution is recorded on-chain, ensuring transparency and legal
          integrity.
        </motion.p>
        ...
        <div className="mt-8 sm:mt-10 flex items-center justify-center gap-3 sm:gap-4">
          <MagneticButton
            href="#apply"
            className="rounded-xl sm:rounded-2xl bg-gradient-to-br from-amber-200 to-yellow-400 text-black/80 px-5 py-2.5 sm:px-6 sm:py-3 font-semibold shadow hover:shadow-lg transition inline-flex items-center gap-2"
          >
            Join <ArrowRight className="h-4 w-4" />
          </MagneticButton>
          <a
            href="#tiers"
            className="rounded-xl sm:rounded-2xl border border-white/20 text-white px-5 py-2.5 sm:px-6 sm:py-3 font-semibold hover:bg-white/10 transition"
          >
            View Tiers
          </a>
        </div>
        ...
        <div className="mt-8 sm:mt-10 flex flex-wrap items-center justify-center gap-4 sm:gap-6 text-white/70 text-xs sm:text-sm">
          <span className="inline-flex items-center gap-2">
            <ShieldCheck className="h-4 w-4" /> On-chain Proof
          </span>
          <span className="inline-flex items-center gap-2">
            <Zap className="h-4 w-4" /> High-throughput L1
          </span>
          <span className="inline-flex items-center gap-2">
            <PieChart className="h-4 w-4" /> DAO Governance
          </span>
        </div>

        {/* тонкий бегущий маркер под hero */}
        <div className="mt-10">
          <div className="marquee">
            <div className="marquee__inner">
              {Array.from({ length: 12 }).map((_, i) => (
                <span key={i}>ON-CHAIN&nbsp;•&nbsp;DAO&nbsp;•&nbsp;AIRDROP&nbsp;•&nbsp;TOKENOMICS&nbsp;•&nbsp;</span>
              ))}
            </div>
          </div>
        </div>
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 grid md:grid-cols-2 gap-6 md:gap-8 items-stretch">
      <GlassCard>
        ...
        <ul className="mt-6 space-y-3 text-white/85">
          ...
          <li className="flex items-start gap-3">
            <span className="mt-1 h-2.5 w-2.5 rounded-full bg-orange-400" /> DAO
            synergy: voting, treasury, and on-chain reporting.
          </li>
        </ul>
      </GlassCard>
      <GlassCard>
  ...
  <section id="tiers" className="relative py-14 sm:py-16 md:py-24 scroll-mt-24">
    <div className="mx-auto max-w-7xl px-4 sm:px-6">
      <div className="text-center mb-8 sm:mb-10">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-white drop-shadow-[0_1px_0_rgba(0,0,0,0.25)]">
          Participation Tiers
        </h2>
            ...
            <TiltCard>
              <GlassCard className="h-full">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] sm:text-xs text-white/70 border border-white/10 rounded-full px-2 py-1">
                    {t.badge}
                  </span>
                </div>
                <div className="mt-4 text-white/85">
                  ...
                  {t.equity && (
                    <div className="mt-2 text-xs sm:text-sm bg-white/5 border border-white/10 rounded-xl px-3 py-2 inline-block">
                      {t.equity}
                    </div>
                  )}
                  ...
                  <a
                    href="#apply"
                    className="mt-6 inline-flex items-center gap-2 rounded-xl border border-white/15 px-4 py-2 text-white hover:bg-white/10 transition"
                  >
                    Apply <ArrowRight className="h-4 w-4" />
                  </a>
                </div>
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 grid lg:grid-cols-2 gap-6 md:gap-8 items-center">
      <GlassCard>
        ...
        <p className="mt-3 text-white/85">
          Every contribution is tied to a transaction. Public registries and
          Merkle proofs confirm participation.
        </p>
      ...
      <GlassCard>
        ...
        <ol className="mt-4 list-decimal pl-5 text-white/85 space-y-2">
          ...
          <li>
            Receive an on-chain receipt and an NFT participation certificate.
          </li>
          <li>
            At the end of the round, $PETB is minted and the airdrop is
            distributed.
          </li>
          <li>
            Manage your stake via the DAO and receive fee revenue sharing.
          </li>
        </ol>
        <div className="mt-6 text-xs text-white/70">
          Important: demonstration interface only. Ensure legal review and
          compliance with your local regulation before any real fundraising.
        </div>
      </GlassCard>
    </div>
  </section>
          ...
          <div className="flex flex-col gap-6">
            <div>
              ...
              <p className="mt-2 text-white/85">
                Share your contact details and intended tier. We’ll reach out
                for KYC/AML and on-chain instructions.
              </p>
            </div>
            ...
            >
              ...
              <div className="sm:col-span-1">
                <label htmlFor="fullName" className="text-sm text-white/75">
                  Full name
                </label>
                <input
                  id="fullName"
              ...
              <div className="sm:col-span-1">
                <label htmlFor="tier" className="text-sm text-white/75">
                  Participation tier
                </label>
                <select
                  id="tier"
              ...
              <div className="sm:col-span-1">
                <label htmlFor="amount" className="text-sm text-white/75">
              ...
              <div className="sm:col-span-2">
                <label htmlFor="message" className="text-sm text-white/75">
                  Message
                </label>
                <textarea
                  id="message"
            ...
            <div className="text-xs text-white/70">
              ...
              Use of the name “Peter Todd” requires appropriate permission/rights.
  ...
  <footer className="relative py-8 sm:py-10 border-t border-white/10">
    <div className="mx-auto max-w-7xl px-4 sm:px-6 flex flex-col md:flex-row items-center justify-between gap-4 text-white/70 text-sm">
      <div className="flex items-center gap-2 sm:gap-3">
        <SparkGlyph className="h-4 w-4 translate-y-[1px]" />
        <WordmarkAww />
        <span className="ml-2 text-white/60 text-xs sm:text-sm">
